const section2Data = [
  {
    ...
    btnText: "Consult Now",
    btnTextColor: "bg-black text-white",
    btnLink: "/contact",
...

  {
    ...
    btnTextColor: "bg-primary text-black",
    btnLink: "/atelier",
...

  {
    ...
    subtitle: "Note",
    para3: "Capital is currently evolving and will expand into a dedicated platform.",
    btnText: "Enter Capital",
    btnTextColor: "bg-primary text-black",
    btnLink: "/capital",
